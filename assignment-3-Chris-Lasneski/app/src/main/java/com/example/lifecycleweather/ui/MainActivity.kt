    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.errorMessage.observe(this) { errorMessage ->
            if (errorMessage != null) {
                ...
                //loadingErrorTV.text = getString(R.string.search_error, errorMessage)
            }
        }

//        val perfs = PreferenceManager.getDefaultSharedPreferences(this)
//        viewModel.loadSearchResults("Corvallis,OR,US", "imperial", OPENWEATHER_APPID)
//        forecastListRV.scrollToPosition(0)
//        perfs.registerOnSharedPreferenceChangeListener { sharedPreferences, key ->
//            /*Do stuff*/
//        }
    ...
    override fun onResume() {
        super.onResume()
        val perfs = PreferenceManager.getDefaultSharedPreferences(this)
        //val query = perfs.getString(getString(R.string.geo_uri), null)
        //if (query != null) {
            viewModel.loadSearchResults("Corvallis,OR,US", "imperial", OPENWEATHER_APPID)
        //}
        forecastListRV.scrollToPosition(0)
